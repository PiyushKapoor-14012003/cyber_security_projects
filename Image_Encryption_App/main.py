...
class ImageEncryption:
    def __init__(self, root):
        ...
        sidebar_image = Image.open("Image_Encryption_App/Images/sidebar.png")
        footer_image = Image.open("Image_Encryption_App/Images/footer.png")
        encrypt_img = PhotoImage(file='Image_Encryption_App/Images/encrypt.png')
        decrypt_img = PhotoImage(file='Image_Encryption_App/Images/decrypt.png')
        self.browse_iv_img = PhotoImage(file='Image_Encryption_App/Images/browse_iv.png')
    ...
    def about(self):
        ...
        developer_info = Label(about_frame, text="**Developed By: Piyush Kapoor", font=("Montserrat", 8, "bold"))
